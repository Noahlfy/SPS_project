...
from backend.data_handler import update_session_stats_for_impact

class Command(BaseCommand):
    help = 'Update session stats based on simulated impact data'
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            update_session_stats_for_impact(session_id)
